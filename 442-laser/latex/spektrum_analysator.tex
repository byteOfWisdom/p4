...
Es ergibt sich eine Steigung von [WERT!] und ein Achenabschnitt von [WERT!]. Die Steigung ist klein genug um in guter Näherung als Null betrachtet zu werden. Es liegt kein relevanter Trend in den Daten vor. 
Aus de mittelwert des  Analysatormodenabstands [WERT!] wird das Verhältnis der Abstände bestimmt zu $q = 2$.
...
\begin{align}
	q &= \frac{\nu_\text{TEM}}{\nu_\text{Laser}} = \frac{2 l}{L}\\
	\imply \nu_\text{Laser} &= \nu_\text{TEM} \cdot q = \frac{q c}{4 l}
\end{align}
