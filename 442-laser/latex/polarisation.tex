...
Bei Ausbreitung in z-Richtung kann so z.B. das elektrische Feld als $E(x,y,z)=a_x \hat{e_x} \sin(kz)+a_y \hat{e_y}\sin(kz-\Phi)$ beschrieben werden.
...
Bei zirkulär polarisierten Licht gilt hingegen $a_x=a_y$, bei elliptisch polarisierten Licht können $a_x$ und $a_y$ beliebige Werte annehmen \cite[560]{gerthsen}.
...
\end{align}
Der Winkel $\alpha$ ist hier der Verdrehwinkel zwischen optischer Achse des Polarisators und der Polarisationsrichtung des Laserstrahls und nicht der am Polarisator-Bauteil eingestellter Winkel.
