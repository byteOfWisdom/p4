...
Faktor der Strahlbreite zu beachten ist.
...
$w \cdot \sqrt{1 + (\frac{(z - y)}{ x(w))})^2}$ an die Datenpunkte angepasst. Der Parameter $y$ wurde für eine Kompensation für mögliche bisher unbeachtete Messversätze für den Abstand eingeführt.
