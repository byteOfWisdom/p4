...
\jafps{graphit_gitter}{Schematische Darstellung der Kristallstruktur von HOPG, Abbildung aus \cite{hopg_sketch}}{0.4}
...
In den Aufnahmen erwarten wir entsprechend Abbildung \ref{fig:graphit_gitter}, ein Muster gleichseitiger Dreiecke mit Seitenlänge $\SI{0.246}{\nano\meter}$ \cite{graphite}. Dieses Muster ist in den Aufnahmen (\ref{fig:res/hopg_166_with_lines}, \ref{fig:res/hopg_165}) optisch zu erkennen, die Gleichseitigkeit der Dreiecke wird im folgenden überprüft.
