...
Anschließend wird die Probe vorbereitet inmdem ein Stück Klebeband-Film auf die Probe geklebt und dann abgezogen wurde. Dies sorgt dafür, dass eine frische, unverschmutzte und näherungsweise ebene Graphitschicht freigelegt wird.
...
\jafps{res/hopg_131}{Übersichtsaufnahme der Graphitoberfläche im konstanten Strom Modus $v_R = \SI{1000.0}{\nano\meter\per\second}$, $I_\text{Setpoint} = \SI{1}{\nano\ampere}$, $P=1000$, $I=2000$}{0.4}
...
In den Aufnahmen erwarten wir entsprechend Abbildung \ref{fig:graphit_gitter}, ein Muster gleichseitiger Dreiecke mit Seitenlänge $\SI{0.246}{\nano\meter}$. Eine gelungene Aufnahme wird nun genutzt um dort den Abstand mehrerer Maxima zueinander zu vermessen. Hierzu wurde die Mess-Funktionalität von gwyddion \cite{gwyddion} verwendet.

% \jafps{res/hopg_166}{\todo{scanspeed}}{0.4}
\jafps{res/hopg_166_with_lines}{Messung des HOPG mit Messlinien zur Bestimmung des Kristallgitters. $v_R = \SI{157.20}{\nano\meter\per\second}$, $I_\text{Setpoint} = \SI{751}{\nano\ampere}$, $P=0$, $I=4$}{0.4}
