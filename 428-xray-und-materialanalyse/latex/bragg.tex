...
\jafpsh{aufbau_bragg}{Skizze des Messaufbaus, entnommen aus \cite[2]{LDBragg}. }{0.4}
...
\]
als Energie in Abhängigkeit des Glanzwinkels des Kristalls $\theta$ aufgetragen. Es wird angenommen, dass nur die erste Ordnung ($n=1$) betrachtet wurde und dass für die genutzte Schneidung und Orientierung des NaCl-Kristalls (als fcc-Gitterstruktur, also \textit{flächenzentriertes Gitter}) der Netzebenenabstand $d=\frac{a}{2}$ (mit $a=\SI{564}{\pico\meter}$ als Gitterkonstante des NaCl-Kristalls\cite{naclgitterkonst}) ist. Diese Auftragung ist in Abbildung \ref{fig:bragg_alldata} dargstellt.
...
\jafps{bragg_fitting_data}{Energiespektrumsausschnitt mit den beobachteten charakteristischen Linien der ersten Ordnung (höchste Intensität, in der Mitte des betrachteten Winkelbereichs) der unbekannten Anode mit Anpassungsfunktion aus sechs Gaußfunktionen für die charakteristischen Linien und einem linearen Untergrund der Bremsstrahlung.}{0.4}
