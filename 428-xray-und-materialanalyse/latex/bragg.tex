...
\]
als Energie in Abhängigkeit des Glanzwinkels des Kristalls $\theta$ aufgetragen. Es wird angenommen, dass nur die erste Ordnung ($n=1$) betrachtet wurde und dass für die genutzte Schneidung und Orientierung des Kristalls der Netzebenenabstand $d=\frac{a}{2}$ (mit $a=\SI{564}{\pico\meter}$ Gitterkonstante des NaCl-Kristalls\cite{naclgitterkonst}) ist. Diese Auftragung ist in Abbildung \ref{fig:bragg_alldata} dargstellt.
