...
\end{align}
Aus der Auftragung der Grenzspannungen $U_0$, die aus den Messungen der einzelnen Wellenlängen bestimmt wurden, gegen die Wellenlängen $\lambda$ können mithilfe einer Geradenanpassung
\[U_0 = a \lambda + b\]
dann der Wert des Plankschen Wirkungsquantums als $h=\frac{a}{e}$ sowie die Austrittsarbeit der verwendeten Pt-Rh-Anode als $W_A=-b \cdot e$ berechnet werden.
