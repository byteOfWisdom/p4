...
Die mittlere freie Weglänge muss in einem Bereich sein, in welchem Elektronen im mittel einige wenige male stoßen. Die mittlere Freie Weglänge hängt vom Druck ab. Damit der Versuch funktioniert muss ein Elektron im Mittel einige wenige Male stoßen ($\mathcal{O}(10)$ mal). Wie man in \ref{fig:hg_vapor} erkennen kann, verändert sich der Druck sehr empfindlich mit der Temperatur, weshalb der nutzbare Bereich der mittleren Freien Weglänge bei Temperaturänderung schnell verlassen wird.

\begin{align}
	\lambda = \frac{1}{\sqrt{2} n \sigma} \text{ und } n \propto 1 / P  \imply \lambda \propto P \label{eq:mfp}
\end{align}
