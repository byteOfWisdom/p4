...
\jafps{zeeman_pixel_x}{Auftragung der Intensitätsmessungen in x-Richtung für alle eingestellten Stromstärken.}{0.34}
\jafps{zeeman_pixel_y}{Auftragung der Intensitätsmessungen in y-Richtung für alle eingestellten Stromstärken.}{0.35}
...
Die so berechneten Winkel der Maxima, Parameter der jeweiligen Gaußfunktion-Anpassung sowie die darauf bestimmten Energieaufspaltungen der Ringe sind im Anhang in der großen Tabelle (\ref{sec:grossetab}) dargestellt.
